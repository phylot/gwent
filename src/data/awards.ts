...
const defaultAwards: Awards = {
  ...
  tactician: { active: false, count: 0, description: "<strong>Win</strong> a match by playing <strong>10 cards or less</strong>.", icon: "gi-brain", name: "Tactician", targetCount: 10 },
