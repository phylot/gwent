...
const allCards: Card[] = [
  ...
  { ability: 'boost', abilityIcon: "fa-plus", active: false, defaultValue: 3, description: "<strong>Morale Boost:</strong> Adds + 1 to all units in the row (excluding itself).", faction: 'br', image: "br-sergent.jpg", name: "Sergent", type: "close", typeIcon: "gi-broadsword", value: 3 },
