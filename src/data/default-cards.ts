...
const allCards: Card[] = [
  ...
  { ability: 'close_scorch', abilityIcon: "io-skull", active: false, defaultValue: 10, description: "Description", faction: 'br', hero: true, image: "br-harper.jpg", name: "Pat Harper", type: "close", typeIcon: "gi-broadsword", value: 10 },
  { ability: 'scorch', abilityIcon: "io-skull", active: false, defaultValue: 15, description: "Description", faction: 'br', hero: true, image: "br-sharpe.jpg", name: "Richard Sharpe", type: "ranged", typeIcon: "gi-crossbow", value: 15 },
