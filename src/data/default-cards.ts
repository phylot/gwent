...
const allOpponentCards: Card[] = [
  ...
  { ability: 'muster', abilityIcon: "gi-two-shadows", active: false, defaultValue: 10, description: "<strong>Muster:</strong> Find the Gaston card in your deck and play it instantly.", faction: 'french', id: "220", image: "fr-general-calvet.png", musterName: "calvet", name: "General Calvet", type: "siege", typeIcon: "gi-catapult", value: 10 },
  ...
  { ability: 'spy', abilityIcon: "hi-solid-eye", active: false, defaultValue: 7, description: "<strong>Spy:</strong> Place on your opponent's battlefield (counts towards opponent's total) and draw 2 cards from your deck.", faction: 'french', id: "227", image: "fr-leroux.png", name: "Helene Leroux", type: "close", typeIcon: "gi-broadsword", value: 7 },
...
const allPlayerCards: Card[] = [
  ...
  { ability: 'heal', abilityIcon: "gi-heart-plus", active: false, defaultValue: 4, description: "<strong>Medic:</strong> Choose one card from your discard pile and play it instantly (no Heroes or Special Cards).", faction: 'british', id: "014", image: "br-harris.jpg", name: "Rifleman Harris", type: "ranged", typeIcon: "gi-crossbow", value: 4 },
