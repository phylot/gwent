...
const allOpponentCards: Card[] = [
  ...
  { ability: 'scorch', abilityIcon: "io-skull", active: false, defaultValue: 0, description: "Discards after playing. Kills the <strong>strongest card(s)</strong> on the battlefield.", faction: 'french', id: "228", image: "scorch.png", name: "Scorch", type: "special", value: 0 },
  { ability: 'scorch', abilityIcon: "io-skull", active: false, defaultValue: 0, description: "Discards after playing. Kills the <strong>strongest card(s)</strong> on the battlefield.", faction: 'french', id: "229", image: "scorch.png", name: "Scorch", type: "special", value: 0 },
...
const allPlayerCards: Card[] = [
  ...
  { ability: 'bond', abilityIcon: "md-handshake-outlined", active: false, defaultValue: 7, description: "<strong>Tight Bond:</strong> Place next to a card with the same name to double the value of both cards.", faction: 'british', id: "018",  image: "br-cannon.jpg", name: "Cannon", type: "siege", typeIcon: "gi-catapult", value: 7 },
  { ability: 'bond', abilityIcon: "md-handshake-outlined", active: false, defaultValue: 7, description: "<strong>Tight Bond:</strong> Place next to a card with the same name to double the value of both cards.", faction: 'british', id: "019",  image: "br-cannon.jpg", name: "Cannon", type: "siege", typeIcon: "gi-catapult", value: 7 },
  { ability: 'bond', abilityIcon: "md-handshake-outlined", active: false, defaultValue: 7, description: "<strong>Tight Bond:</strong> Place next to a card with the same name to double the value of both cards.", faction: 'british', id: "020",  image: "br-cannon.jpg", name: "Cannon", type: "siege", typeIcon: "gi-catapult", value: 7 },
  ...
  { ability: 'scorch', abilityIcon: "io-skull", active: false, defaultValue: 0, description: "Discards after playing. Kills the <strong>strongest card(s)</strong> on the battlefield.", faction: 'british', id: "026", image: "scorch.png", name: "Scorch", type: "special", value: 0 },
  { ability: 'scorch', abilityIcon: "io-skull", active: false, defaultValue: 0, description: "Discards after playing. Kills the <strong>strongest card(s)</strong> on the battlefield.", faction: 'british', id: "027", image: "scorch.png", name: "Scorch", type: "special", value: 0 },
