...
const allCards: Card[] = [
  ...
  { ability: 'double', abilityIcon: "gi-hunting-horn", active: false, defaultValue: 0, description: "Description", image: "horn.png", name: "Commander's Horn", type: "special", value: 0 },
